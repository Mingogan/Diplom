...
public class CookOrdersAdapter extends ArrayAdapter<Orders> {
    ...
    public CookOrdersAdapter(Context context, List<Orders> ordersList, WaiterOrdersViewModel waiterOrderViewModel, LifecycleOwner lifecycleOwner) {
        ...
        this.originalFormat.setTimeZone(TimeZone.getTimeZone("Asia/Novosibirsk"));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewTableNumber.setText("Table: " + order.getTable().getTableNumber());
        textViewOrderNumber.setText("Order: " + order.getId());
        textViewOrderStatus.setText(order.getStatus().getStatusName());
        textViewWaiterName.setText("Waiter: " + order.getWaiter().getFirstName()+" " + order.getWaiter().getLastName());
        ...
        try {
            ...
            Log.d("WaiterTableOrderFragment", order.getDateOfCreation().toString());
        }
        ...
        convertView.setOnClickListener(v -> {
            ...
            CookOrderDetailsFragment fragment = CookOrderDetailsFragment.newInstance(order.getId(),order.getStatus().getStatusName());
